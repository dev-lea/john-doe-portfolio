...
export default function Portfolio(){
  return (
    <>
      <Seo title="Portfolio — John Doe" description="Quelques-unes de mes réalisations (6 projets)." />
      ...
      <Container className="pb-5">
        <Row className="gy-4">
          ...
          <Col md={4}><PortfolioCard img={seoImg}  title="SEO"                  desc="Amélioration du référencement d’un site e-commerce" footer="Utilisation des outils SEO" /></Col>
          ...
          <Col md={4}><PortfolioCard img={screens} title="Maquette d'un site"   desc="Création d’un prototype de site" footer="Réalisé avec FIGMA" /></Col>
        </Row>
      </Container>
    </>
  );
